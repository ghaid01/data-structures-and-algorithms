...
//The charAt() method returns the character at the specified index in a string(index of the first character is 0, the second character is 1, and so on)
...
let biggerThanLuke = (arr) => {
  const massOfLuke = 77;
  return arr.filter(value => parseInt(value.mass) > massOfLuke )
